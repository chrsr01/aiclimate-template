...
def test_env_should_come_with_default_extensions() -> None:
    ...
    assert 'aiclimate.extensions.JsonifyExtension' in env.extensions
    assert 'aiclimate.extensions.RandomStringExtension' in env.extensions
    assert 'aiclimate.extensions.SlugifyExtension' in env.extensions
    assert 'aiclimate.extensions.TimeExtension' in env.extensions
    assert 'aiclimate.extensions.UUIDExtension' in env.extensions
